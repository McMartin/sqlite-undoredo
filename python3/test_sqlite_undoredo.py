...
class SQLiteUndoRedoTest(unittest.TestCase):
    ...
    def test_commit(self):
        ...
        self.assertEqual(self._select_all('undo_redo_step'), [(1, 0, "Add 23")])
        self.test_cursor.execute("INSERT INTO tbl1 VALUES(?)", (42,))

        self.history.commit("Add 42")

        self.assertEqual(
            self._select_all('undo_redo_step'), [(1, 0, "Add 23"), (2, 0, "Add 42")]
        )
    ...
    def test_commit_several_changes(self):
        ...
        self.assertEqual(self._select_all('undo_redo_step'), [(1, 0, "Add 23 and 42")])
    ...
    def test_undo(self):
        ...
        mock_step.assert_called_with(is_redo=False)
    ...
    def test_undo_insert(self):
        ...
        self.assertEqual(self._select_all('undo_redo_step'), [(1, 1, "Add 23")])
    ...
    def test_undo_update(self):
        ...
        self.assertEqual(
            self._select_all('undo_redo_step'),
            [(1, 0, "Add 23"), (2, 1, "Change 23 to 42")],
        )
        self.assertEqual(self._select_all('tbl1'), [(23,)])
    ...
    def test_undo_delete(self):
        ...
        self.assertEqual(
            self._select_all('undo_redo_step'), [(1, 0, "Add 23"), (2, 1, "Remove 23")]
        )
        self.assertEqual(self._select_all('tbl1'), [(23,)])
    ...
    def test_undo_several_changes(self):
        ...
        self.assertEqual(self._select_all('undo_redo_step'), [(1, 1, "Several changes")])
        self.assertEqual(self._select_all('tbl1'), [])
    ...
    def test_redo(self):
        ...
        mock_step.assert_called_with(is_redo=True)
    ...
    def test_redo_update(self):
        ...
        self.assertEqual(
            self._select_all('undo_redo_step'),
            [(1, 0, "Add 23"), (2, 0, "Change 23 to 42")],
        )
        self.assertEqual(self._select_all('tbl1'), [(42,)])
    ...
    def test_redo_delete(self):
        ...
        self.assertEqual(
            self._select_all('undo_redo_step'), [(1, 0, "Add 23"), (2, 0, "Remove 23")]
        )
        self.assertEqual(self._select_all('tbl1'), [])
    ...
    def test_redo_several_changes(self):
        ...
        self.assertEqual(self._select_all('undo_redo_step'), [(1, 0, "Several changes")])
        self.assertEqual(self._select_all('tbl1'), [(69,)])

    def test___init__(self):
        self.assertIs(self.history._cursor, self.test_cursor)
        self.assertEqual(self._select_all('undo_redo_step'), [], [])
